  ...
  List<MathSubject> get defaultSubjects {
    switch (this) {
      case MathCategory.basic:
        return const <MathSubject>[MathSubject.general, MathSubject.arithmetic];
...
const Map<String, List<String>> _mathSearchAliases = <String, List<String>>{
  r'\frac{}{}': <String>[
    'fraction',
    'divide',
    'numerator',
  ...
  r'\approx': <String>['approximately', 'approximately equal', 'roughly equal'],
