...
const List<MathSymbol> mathSymbols = [
  ...
  MathSymbol(label: 'sin θ', tex: r'\sin \theta', category: MathCategory.trig),
  MathSymbol(label: 'cos θ', tex: r'\cos \theta', category: MathCategory.trig),
  MathSymbol(label: 'tan θ', tex: r'\tan \theta', category: MathCategory.trig),
  ...
  MathSymbol(label: 'rad', tex: r'\text{rad}', category: MathCategory.trig),
  MathSymbol(label: 'φ', tex: r'\phi', category: MathCategory.trig),
  MathSymbol(label: 'α', tex: r'\alpha', category: MathCategory.trig),
  MathSymbol(label: 'β', tex: r'\beta', category: MathCategory.trig),
