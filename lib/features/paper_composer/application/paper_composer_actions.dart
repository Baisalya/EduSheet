...
class PaperComposerActions {
  ...
  void updateSectionStructure(
    ...
    required PaperTextAlignment headingAlignment,
    required PaperTextAlignment instructionAlignment,
    required PaperTextAlignment answerRuleAlignment,
    required bool showInstructionLabel,
    required bool headingBold,
    required bool headingUppercase,
    required bool headingBoxed,
    required SectionHeadingSize headingSize,
    required SectionSpacing spacing,
    required SectionMarksDisplay sectionMarksDisplay,
    required QuestionMarksPlacement questionMarksPlacement,
    ...
    _editor.updateSection(
      ...
      answerRuleAlignment: answerRuleAlignment,
