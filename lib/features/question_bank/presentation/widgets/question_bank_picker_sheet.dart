...
class QuestionBankPickerSheet extends ConsumerStatefulWidget {
  ...
  static Future<List<QuestionBankQuestion>?> show(
    ...
    return showModalBottomSheet<List<QuestionBankQuestion>>(
      context: context,
      useSafeArea: true,
...
class _QuestionBankPickerSheetState
  ...
  Widget build(BuildContext context) {
    ...
    final subjects = state.questions
    ...
    final chapters = state.questions
        .where(
          (entry) =>
    ...
    final questions = state.questions.where((entry) {
      ...
      return (effectiveSubject == null || entry.subject == effectiveSubject) &&
    ...
    final exceedsMaximum = widget.maximumMarks != null &&
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        if (entry.isFavorite)
                          const _Meta(label: 'Favorite', icon: Icons.star_rounded),
                      ],
                    ),
                  ],
                ),
