...
void main() {
  test('CSV parser supports quoted commas and multiline quoted fields', () async {
    final directory = await Directory.systemTemp.createTemp('edusheet-csv-test');
  ...
  test('XLSX parser preserves sheets, sparse row numbers and cell values', () async {
    final directory = await Directory.systemTemp.createTemp('edusheet-xlsx-test');
    addTearDown(() => directory.delete(recursive: true));
    final file = File('${directory.path}${Platform.pathSeparator}sample.xlsx');
