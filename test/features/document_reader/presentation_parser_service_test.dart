...
void main() {
  test('PPTX parser keeps slide order, layout text and transition metadata', () async {
    final directory = await Directory.systemTemp.createTemp('edusheet-pptx-test');
    addTearDown(() => directory.delete(recursive: true));
    final file = File('${directory.path}${Platform.pathSeparator}sample.pptx');
